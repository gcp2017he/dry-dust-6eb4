...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/dry-dust-6eb4#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dry-dust-6eb4
```

A live public deployment of this template is available at [https://dry-dust-6eb4.templates.workers.dev](https://dry-dust-6eb4.templates.workers.dev)
